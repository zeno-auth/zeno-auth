...
final class Version20180115120151 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE zeno_auth_users (id UUID NOT NULL, username VARCHAR(10) NOT NULL, password JSON DEFAULT NULL, email VARCHAR(50) NOT NULL, name VARCHAR(200) NOT NULL, last_login_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
